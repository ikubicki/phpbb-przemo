...
$lang['Wrong_checksum'] = 'Some files sent to a server have wrong content (they\'re probably damaged)<br />If you haven\'t edited any files then this means that problems occured when sending them to the server. Try sending the files shown below one more time. You could try turning binary mode on and off. <br /><br />If you edited the files purposely click <a href="%s">HERE</a> to install your forum. But <font color="red"><b>ONLY in this case!</b></font> If you downloaded the original pack from http://www.przemo.org/phpBB2 and didn\'t change any files, try sending them to the server again. In any other case you discussion board won\'t work!</font>';
