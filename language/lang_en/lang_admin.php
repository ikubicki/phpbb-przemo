...
$lang['log_file_limit_info'] = 'Log file <b>/admin/admin_logs.php</b> is too big (%sMb) to open in browser.<br /><br />File was compressed to: <b>%s</b><br /><br />Click %sHere%s to get it.<br /><br />After downloading you need to remove the file from FTP.';
...
$lang['Forum_last_update_check_minutes_ago'] = '%d minutes ago';
$lang['Forum_last_update_check_hours_ago'] = '%d hours ago';
$lang['Forum_last_update_check_days_ago'] = '%d days ago';
//
// That's all Folks!
// -------------------------------------------------
