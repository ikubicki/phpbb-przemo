	...
	<!-- BEGIN attach_row -->
		<tr> 
			...
			<td class="row1"><span class="gen"> <a class="gen" href="{attach_row.U_VIEW_ATTACHMENT}" target="_blank">{attach_row.FILE_NAME}</a></span>
			</td> 
		</tr>
    	<tr> 
			<td class="row1"><span class="gen"><b>{L_FILE_COMMENT}</b></span></td> 
			<td class="row1"><span class="genmed"><textarea name="comment_list[]" rows="3" cols="35" size=40 class="post">{attach_row.FILE_COMMENT}</textarea></span>	
		    </td> 
		</tr>
    	<tr> 
