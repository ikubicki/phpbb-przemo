...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline" align="center">
	...
	<!-- BEGIN blockrow -->
	<tr>
		<td width="100%"><span class="cattitle"><a name="{blockrow.BLOCK_ANCHOR}">{blockrow.BLOCK_TITLE}</a></span></td>
		...
		<td align="center" valign="middle" nowrap="nowrap"><span class="gen"><a href="{blockrow.U_BLOCK_MOVE_DOWN}">{L_MOVE_DOWN}</a></span></td>
	</tr>
	<!-- BEGIN questrow -->
	<tr> 
	...
	<!-- BEGIN no_blocks -->
	<tr>
		<td colspan="5"><span class="cattitle">{L_NO_BLOCKS}</span></td>
	</tr>
	<!-- END no_blocks -->
	<tr>
		<td colspan="5">
