...
<form method="get" action="{S_REBUILD_SEARCH_ACTION}">
	<table cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
		...
		<tr>
			<td class="submit" colspan="2" align="center"><input type="hidden" name="sid" value="{SESSION_ID}"><input type="hidden" name="start" value="0"><input class="mainoption" type="submit" name="submit" value="{L_REBUILD_SEARCH}"></td>
		</tr>
	</table>
</form>
<br>