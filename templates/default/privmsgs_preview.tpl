...
<table border="0" cellpadding="4" cellspacing="1" width="100%" class="forumline">
  ...
  <tr> 
	...
	<td width="100%" class="row2"><span class="genmed"><a href="{MESSAGE_FROM_URL}" class="name"{MESSAGE_FROM_STYLE}>{MESSAGE_FROM}</a></span></td>
  </tr>
  <tr> 
	<td class="row2"><span class="genmed">{L_TO}:</span></td>
	<td width="100%" class="row2"><span class="genmed"><a href="{MESSAGE_TO_URL}" class="name"{MESSAGE_TO_STYLE}>{MESSAGE_TO}</a></span></td>
  </tr>
  <tr> 
