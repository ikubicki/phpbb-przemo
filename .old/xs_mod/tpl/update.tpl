...
<tr>
	<th colspan="4" align="center">{L_XS_UPDATES}</th>
</tr>
<tr>
...
<tr>
	...
	<tr>
		<td class="submit" colspan="4" align="center">{S_HIDDEN_FIELDS}<input type="submit" name="submit" value="{L_XS_UPDATE_CONTINUE}" class="mainoption" /></td>
	</tr>
</table>
</form>
