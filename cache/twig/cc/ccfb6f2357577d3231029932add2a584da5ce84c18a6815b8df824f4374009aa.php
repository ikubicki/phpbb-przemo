...
/* forms/select.html */
class __TwigTemplate_fb79c417aadb10d4243afa93aa8bc9eb0f2b61acb308a9f7010d0496677413c6 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% if field.error %}<span class=\"error\">{{ field.error }}</span>{% endif %}", "forms/select.html", "/var/www/app/htdocs/assets/default/html/forms/select.html");
    }
}
