...
/* forms/password.html */
class __TwigTemplate_20ed004812fd164247f8c855614d3e039ea8298b7460516ef55fd7a7d84994e0 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% if field.error %}<span class=\"error\">{{ field.error }}</span>{% endif %}", "forms/password.html", "/var/www/app/htdocs/assets/html/forms/password.html");
    }
}
