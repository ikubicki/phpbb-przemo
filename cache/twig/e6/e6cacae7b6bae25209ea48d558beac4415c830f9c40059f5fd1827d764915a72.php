...
/* forms/password.html */
class __TwigTemplate_ca41b0b7f04e214f8c160dc099de6de6e463e81a3720901dd20c149c14cf1004 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<input type=\"password\" name=\"{{ field.name }}\" value=\"{{ field.value }}\" class=\"{% if field.error %}error{% endif %}\" />
{% if field.error %}<span class=\"error\">{{ field.error }}</span>{% endif %}", "forms/password.html", "/var/www/app/htdocs/assets/default/html/forms/password.html");
    }
}
