...
/* forms/text.html */
class __TwigTemplate_78cefd32a99f141ec964cc077e805757719afbb74243f79ea4f5fe58c33d7289 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% if field.error %}<span class=\"error\">{{ field.error }}</span>{% endif %}", "forms/text.html", "/var/www/app/htdocs/assets/html/forms/text.html");
    }
}
